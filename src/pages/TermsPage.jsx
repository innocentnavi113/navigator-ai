export default function TermsPage() {
  const s = {
    ...
    logo: { fontWeight: 800, fontSize: '1rem', letterSpacing: '0.08em', cursor: 'pointer', color: '#ff2a2a' },
    back: { background: 'none', border: '1px solid rgba(255,42,42,0.3)', color: '#888', padding: '8px 16px', borderRadius: '6px', fontSize: '0.78rem', cursor: 'pointer', fontFamily: "'JetBrains Mono', monospace", letterSpacing: '0.05em' },
    main: { maxWidth: 760, margin: '0 auto', padding: '60px 24px 80px' },
    eyebrow: { fontFamily: "'JetBrains Mono', monospace", fontSize: '0.7rem', letterSpacing: '0.25em', color: '#ff2a2a', marginBottom: 16, fontWeight: 800, textTransform: 'uppercase' },
    h1: { fontSize: '2rem', fontWeight: 800, margin: '0 0 12px', lineHeight: 1.2, letterSpacing: '0.02em', textTransform: 'uppercase' },
    meta: { fontFamily: "'JetBrains Mono', monospace", fontSize: '0.72rem', color: '#444', marginBottom: 52, letterSpacing: '0.03em' },
    ...
    h2: { fontSize: '0.92rem', fontWeight: 800, margin: '0 0 16px', paddingBottom: 12, borderBottom: '1px solid rgba(255,255,255,0.06)', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#f0f0f0' },
    riskH2: { fontSize: '0.92rem', fontWeight: 800, margin: '0 0 16px', paddingBottom: 12, borderBottom: '1px solid rgba(255,42,42,0.25)', color: '#ff2a2a', letterSpacing: '0.1em', textTransform: 'uppercase' },
    p: { fontSize: '0.82rem', lineHeight: 1.8, color: '#999', margin: '0 0 10px', letterSpacing: '0.02em' },
    contact: { background: 'rgba(255,42,42,0.05)', border: '1px solid rgba(255,42,42,0.25)', borderRadius: 12, padding: '24px 32px', fontSize: '0.8rem', color: '#888', lineHeight: 1.8, letterSpacing: '0.02em' },
    footer: { borderTop: '1px solid rgba(255,42,42,0.15)', padding: '32px 24px 48px', textAlign: 'center' },
    disclaimer: { fontSize: '0.72rem', color: '#666', maxWidth: 560, margin: '0 auto 10px', lineHeight: 1.6, letterSpacing: '0.03em' },
    copy: { fontFamily: "'JetBrains Mono', monospace", fontSize: '0.68rem', color: '#444', letterSpacing: '0.08em' },
  }
